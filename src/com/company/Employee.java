...
public class Employee {
    ...
    void viewItems(Statement statement) throws SQLException { // TODO: Add acronym
    ...
    void deleteCategory(Statement statement) {
    ...
    void editCategory(Statement statement) { //TODO: Check if categoryName exists already + ask user for id and new name
        int id = 3;
        String changedName = "\"yolo\"" ;
        String EDIT_CAT_QUERY = "UPDATE category SET CategoryName = "+ changedName +" WHERE id = "+ id +";";
    }

    void createCategory(Statement statement) { //TODO: Check if categoryName exists already + ask user for new categorys name
    ...
    void editItem(Statement statement) {
        //TODO: Ask user for new info
        String EDIT_ITEM_QUERY = "";

    }
    void createItem(Statement statement) {
